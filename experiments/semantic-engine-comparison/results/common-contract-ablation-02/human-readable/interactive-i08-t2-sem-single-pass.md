# I08 — SEM_SINGLE_PASS — INTERACTIVE T2
...
Artefact : `experiments/semantic-engine-comparison/results/common-contract-ablation-02/native-outputs/interactive-i08-t2-sem-single-pass.json`
...
```json
{
    ...
    "explicit": {
      "entries": [
        ...
        },
        {
          ...
          "mappedClientElementIds": [],
          "mappedClientRelationIds": [],
          "normalizedMeaning": "Refus de la définition formelle",
  ...
  "initialReconstruction": {
    ...
    "candidateId": "candidate-ke1-fixed-01",
    ...
    "language": "fr",
    "missingConcepts": [],
    "normalizedMeaning": "Analyse exploratoire de la maladie de Fabry évaluant le T1 natif avant la phase de fibrose, sans l'avoir fixé comme critère principal suite à la réponse négative, en tenant compte de l'ECV mesurée à Lyon, avec l'objectif prioritaire d'identifier un marqueur précoce universellement mesurable dans tous les centres.",
    "relations": [
      {
    ...
    "routeProposal": {
      ...
      "reason": "L'utilisateur structure une étude clinique pour la maladie de Fabry en discutant des marqueurs, des centres et des critères, malgré des points de design encore ouverts.",
      "route": "DESIGN_STUDY"
    },
    "semanticInventory": {
      "explicitFragments": [
        ...
        },
        {
          ...
          "modifiers": [],
          "normalizedLabel": "Refus de la définition formelle",
          "polarity": "NEGATED",
          "sourceMessageId": "I08:SEM_SINGLE_PASS:R1",
          "sourceText": "Non"
        }
    ...
    "semanticWarnings": [
      ...
      "DETERMINISTIC_INVENTORY_RELATION_SOURCE_SPAN_DERIVED:4"
    ],
    "summaryForUser": "Prise en compte de votre réponse négative : le statut de critère principal pour le T1 natif reste ouvert, tandis que la recherche d'un marqueur précoce universel pour la maladie de Fabry continue d'être structurée.",
    "unknowns": [
  ...
  "model": {
    ...
    "elements": [
      {
        ...
        "provenance": {
          ...
          "providerCallId": "gemini-call:ke1-4c0f5594aae2adc8",
    ...
    "executionSnapshot": {
      ...
      "executedAt": "2026-08-14T09:25:05.799Z",
      ...
      "reconstructionAttempts": [
        {
          ...
          "providerError": null,
          "providerStatus": null,
          "requestFinished": "2026-08-14T09:24:55.869Z",
          "requestStarted": "2026-08-14T09:24:48.883Z",
          "retryable": false
        },
        {
          "attempt": 1,
          ...
          "providerError": null,
          "providerStatus": null,
          "requestFinished": "2026-08-14T09:25:05.788Z",
          "requestStarted": "2026-08-14T09:24:55.881Z",
          "retryable": false
        }
      ],
      "reconstructionCallId": "gemini-call:ke1-4c0f5594aae2adc8",
    ...
    "history": [
      ...
      {
        "changeReason": "Nouvelle contribution utilisateur analysée sans réécriture de l’état antérieur.",
        "changedAt": "2026-08-14T09:22:20.855Z",
        "digest": "ke1-02bc9b7f7ccf41d3",
        "modelId": "semantic-model:ke1-347a605217e07866",
        "revision": 2,
        "status": "CLARIFICATION_REQUIRED"
      }
    ],
    ...
    "previousModelId": "semantic-model:ke1-347a605217e07866",
    ...
    "semanticModelId": "semantic-model:ke1-1b0ee9f98ce20c45",
    ...
    "updatedAt": "2026-08-14T09:25:05.799Z"
  },
