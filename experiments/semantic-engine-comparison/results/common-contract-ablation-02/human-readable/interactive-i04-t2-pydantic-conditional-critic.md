# I04 — PYDANTIC_CONDITIONAL_CRITIC — INTERACTIVE T2
...
Artefact : `experiments/semantic-engine-comparison/results/common-contract-ablation-02/native-outputs/interactive-i04-t2-pydantic-conditional-critic.json`
