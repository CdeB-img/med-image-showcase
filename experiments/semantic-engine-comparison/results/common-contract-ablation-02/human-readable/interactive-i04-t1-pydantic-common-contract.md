# I04 — PYDANTIC_COMMON_CONTRACT — INTERACTIVE T1
...
Artefact : `experiments/semantic-engine-comparison/results/common-contract-ablation-02/native-outputs/interactive-i04-t1-pydantic-common-contract.json`
