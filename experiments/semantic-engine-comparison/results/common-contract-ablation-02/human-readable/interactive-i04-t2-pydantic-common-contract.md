# I04 — PYDANTIC_COMMON_CONTRACT — INTERACTIVE T2
...
Artefact : `experiments/semantic-engine-comparison/results/common-contract-ablation-02/native-outputs/interactive-i04-t2-pydantic-common-contract.json`
