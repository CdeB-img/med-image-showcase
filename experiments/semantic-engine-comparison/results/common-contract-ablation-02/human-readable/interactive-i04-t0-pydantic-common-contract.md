# I04 — PYDANTIC_COMMON_CONTRACT — INTERACTIVE T0
...
Artefact : `experiments/semantic-engine-comparison/results/common-contract-ablation-02/native-outputs/interactive-i04-t0-pydantic-common-contract.json`
