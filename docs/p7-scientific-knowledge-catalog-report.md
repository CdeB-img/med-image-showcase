...
Branche `main`, HEAD `dd3b5c1170119810514a7c1d8f01f5a8683ef5ad`. Les travaux cohérents P1–P6 sont préservés. Aucun commit, push ou déploiement n'a été effectué.

## 2. Périmètre vérifiable

Le catalogue est exhaustif dans le périmètre `REPOSITORY_OBSERVED_PLANNED_AND_CATALOG_EXECUTED` : 118 identités historiques, 42 concepts P4R, 60 concepts P5, 15 concepts issus de la première campagne, 6 domaines enrichis et 9 domaines encore planifiés. Il ne prétend pas constituer une taxonomie universelle de toute la radiologie.

## 3. Résumé

KnowledgeNodes : 250. Concepts : 235. Domaines : 15. Sources référencées : 92. Assertions existantes reliées : 177. EvidenceLinks existants reliés : 214.

Profondeur maximale : 2. Densité dirigée : 0.002233. Nœuds complets : 82. Nœuds incomplets : 168.

Projections virtuelles estimées : 1475, dont 1184 opportunités de pages. Ces nombres sont des capacités calculées, pas un plan de publication ni des pages générées.
...
| Imagerie hépatique | Domain | HIGH (93) | PROJECTED | HIGH (0.8148) | 22 | 5 |
...
| CT | Modality | HIGH (91) | PROJECTED | COMPLETE (1) | 52 | 25 |
| IRM | Modality | HIGH (91) | PROJECTED | COMPLETE (1) | 130 | 48 |
...
| IRM encodée par déplacement chimique | MeasurementMethod | MEDIUM (40) | PROJECTED | PARTIAL (0.5417) | 1 | 1 |
| Observation hépatique | Observation | MEDIUM (44) | PROJECTED | PARTIAL (0.6587) | 2 | 1 |
| Fraction de graisse hépatique en densité de protons | DerivedMeasurement | HIGH (69) | PROJECTED | PARTIAL (0.7037) | 7 | 2 |
| Carcinome hépatocellulaire | Disease | HIGH (56) | PROJECTED | PARTIAL (0.6528) | 3 | 1 |
| LI-RADS | Standard | MEDIUM (46) | PROJECTED | PARTIAL (0.6587) | 3 | 1 |
| Foie | Organ | LOW (28) | MODELING | LOW (0.2222) | 0 | 1 |
| Concentration hépatique en fer | DerivedMeasurement | HIGH (57) | PROJECTED | PARTIAL (0.6481) | 3 | 1 |
| Élastographie IRM hépatique | MeasurementMethod | MEDIUM (41) | PROJECTED | PARTIAL (0.5417) | 1 | 1 |
| Répétabilité de l'élastographie IRM hépatique | QualityMetric | MEDIUM (42) | PROJECTED | PARTIAL (0.6667) | 3 | 1 |
| Rigidité hépatique | DerivedMeasurement | MEDIUM (51) | PROJECTED | PARTIAL (0.537) | 1 | 1 |
| Imagerie hépatique multiphasique | AcquisitionMethod | MEDIUM (39) | PROJECTED | PARTIAL (0.5417) | 1 | 1 |
| Relaxométrie R2 | MeasurementMethod | MEDIUM (35) | MODELING | LOW (0.2222) | 0 | 1 |
| Relaxométrie R2* | MeasurementMethod | MEDIUM (46) | PROJECTED | PARTIAL (0.6528) | 3 | 1 |
| Fraction graisseuse de signal | DerivedMeasurement | MEDIUM (52) | PROJECTED | PARTIAL (0.537) | 1 | 1 |
| Méthode du rapport d'intensité de signal | MeasurementMethod | MEDIUM (35) | MODELING | LOW (0.2222) | 0 | 1 |
...
| Imagerie hépatique | 0 | 17 | 0 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, Documentation, API |
...
| CT | 4 | 0 | 26 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, API |
| IRM | 5 | 0 | 62 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, API |
...
| IRM encodée par déplacement chimique | 1 | 0 | 1 | Glossary, Guide, FAQ, Comparison, ScientificSummary, Tutorial, Reference, API |
| Observation hépatique | 1 | 0 | 3 | Glossary, Guide, FAQ, ScientificSummary, Reference, ViewerOverlay, API |
| Fraction de graisse hépatique en densité de protons | 1 | 0 | 2 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, ViewerOverlay, API |
| Carcinome hépatocellulaire | 1 | 0 | 1 | Glossary, Guide, FAQ, StateOfKnowledge, ScientificSummary, Reference, CaseStudy, API |
| LI-RADS | 1 | 0 | 3 | Glossary, Guide, FAQ, ScientificSummary, Reference, Documentation, API |
| Foie | 1 | 0 | 0 | Glossary, Guide, Reference, API |
| Concentration hépatique en fer | 1 | 0 | 2 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, ViewerOverlay, API |
| Élastographie IRM hépatique | 1 | 0 | 2 | Glossary, Guide, FAQ, Comparison, ScientificSummary, Tutorial, Reference, API |
| Répétabilité de l'élastographie IRM hépatique | 1 | 0 | 1 | Glossary, Guide, FAQ, ScientificSummary, Reference, API |
| Rigidité hépatique | 1 | 0 | 1 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, ViewerOverlay, API |
| Imagerie hépatique multiphasique | 1 | 0 | 3 | Glossary, Guide, FAQ, Comparison, ScientificSummary, Tutorial, Reference, API |
| Relaxométrie R2 | 1 | 0 | 0 | Glossary, Guide, Tutorial, Reference, API |
| Relaxométrie R2* | 1 | 0 | 2 | Glossary, Guide, FAQ, Comparison, ScientificSummary, Tutorial, Reference, API |
| Fraction graisseuse de signal | 1 | 0 | 2 | Glossary, Guide, FAQ, Comparison, StateOfKnowledge, ScientificSummary, Reference, ViewerOverlay, API |
| Méthode du rapport d'intensité de signal | 1 | 0 | 0 | Glossary, Guide, Tutorial, Reference, API |
...
Couverture scientifique moyenne : 0.538. Couverture éditoriale structurée moyenne : 0.542. Contradictions conservées : 7. Questions ouvertes : 21. Synthèses existantes : 27. Projections internes existantes : 24.

## 7. Campagnes automatiques

Campagnes exécutées : 1. Campagne terminée : `noxia:scientific-campaign:hepatic-imaging:01`. La campagne suivante n'a pas été lancée.
...
Le moteur a sélectionné 9 nœuds dans 9 campagnes. Les critères sont cumulatifs : priorité HIGH, statut non prêt/non terminal, couverture source insuffisante et couverture assertion insuffisante.
...
| --- | --- | --- | --- |
| P5 baseline preserved | true | validate:scientific-multidomain | The P7 corpus is isolated in the catalog-selected campaign layer; P4R and P5 registries are unchanged. |
...
| First campaign selected automatically | true | 1 execution and 9 remaining deterministic campaigns | No prompt-selected domain, next campaign or publication. |
...
| editorial-engine unchanged | true | not found | Separate repository remains unchanged. |

## 10. Fichiers

Créés : `src/knowledge-graph/scientific-campaigns/hepatic-imaging.mjs`, `src/knowledge-graph/scientific-campaigns/execution.mjs`, `src/knowledge-graph/scientific-campaigns/validate.mjs`, `src/knowledge-graph/scientific-campaigns/report.mjs`, `src/knowledge-graph/scientific-campaigns/scientific-campaigns.test.mjs`, `src/knowledge-graph/scientific-campaigns/automatic-campaign-trace.json`, `scripts/execute-scientific-campaign.mjs`, `scripts/validate-scientific-campaign.mjs`, `scripts/report-scientific-campaign.mjs`, `scripts/generate-p7-scientific-campaign-report.mjs`, `scripts/generate-current-knowledge-catalog-report.mjs`, `docs/p7-catalog-driven-scientific-campaign.md`, `docs/p7-first-automatic-scientific-campaign-report.md`, `docs/p7-scientific-knowledge-catalog-report.md`.

Modifiés : `package.json`, `src/knowledge-graph/index.mjs`, `src/knowledge-graph/knowledge-catalog/catalog-builder.mjs`, `src/knowledge-graph/knowledge-catalog/constants.mjs`, `src/knowledge-graph/knowledge-catalog/knowledge-catalog.json`, `src/knowledge-graph/knowledge-catalog/knowledge-catalog.test.mjs`, `src/knowledge-graph/knowledge-catalog/report.mjs`, `src/knowledge-graph/knowledge-catalog/validators.mjs`.

## 11. Validation

Validation P7 : PASS. Digest déterministe : `0499f51a39b19633e539ec5c2711a8897c9e4a0beaef1aa3a1993309b7fb8162`.
