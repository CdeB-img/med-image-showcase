...
Conclusion candidate B1, non humaine : `PARENTAGE_REVIEW_REQUIRED` ; Ellipses sur sous-groupe et régions de flux avec correction de priorité ; structure non dérivée des cas Development. Contamination évidente identifiée : non.
