...
const OutilsViewer: React.FC<OutilsViewerProps> = ({
  className
}) => {
  ...
  return <div className={cn("space-y-12", className)}>
      ...
      <section className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 space-y-4">
        <p className="text-muted-foreground leading-relaxed">Développement d’outils dédiés à l’analyse, à la quantification et à l’exploration avancée des données d’imagerie médicale, explicite et orientée usages réels.<em>signal-driven</em>, explicite et orientée usages réels.
        </p>
      ...
      <section className="space-y-6">
        ...
        <ImageBlock>
          <img src={`${RAW_BASE}/outils/pneumo.png`} alt="Analyse quantitative du parenchyme pulmonaire en scanner thoracique" className="w-full h-auto object-contain" loading="lazy" draggable={false} onContextMenu={e => e.preventDefault()} />
        </ImageBlock>
      </section>
      ...
      <section className="space-y-6">
        ...
        <ImageBlock>
          <img src={`${RAW_BASE}/outils/spectral.png`} alt="Cartographies matériaux et imagerie CT spectrale" className="w-full h-auto object-contain" loading="lazy" draggable={false} onContextMenu={e => e.preventDefault()} />
        </ImageBlock>
      </section>
      ...
      <section className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">Approche fondée sur la compréhension fine du signal, des métadonnées DICOM, de la géométrie et des unités physiques, avec une séparation claire entre visualisation et quantification.</p>
        ...
        <p className="text-center text-sm italic text-muted-foreground pt-4 border-t border-border">Chaque outil est conçu comme un objet méthodologique interprétable; jamais comme une boîte noire.</p>
      </section>
    </div>;
};
...
function ImageBlock({
  ...
  return <div className="w-full overflow-hidden rounded-xl border border-border bg-surface">
      {children}
    </div>;
}
function Feature({
