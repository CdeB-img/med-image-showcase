...
export default function ProtocolDesignerDemo() {
  ...
  const knowledgeResult = useMemo(() => intent && routeIntent === "UNDERSTAND" ? executeKnowledgeEngine({
