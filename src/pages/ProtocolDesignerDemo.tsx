import ProjectWorkspace from "@/features/protocol-designer/functional-reset/ProjectWorkspace";
...
export default function ProtocolDesignerDemo() {
  ...
  return <ProjectWorkspace traceCaptureConfiguration={captureConfiguration} />;
}
