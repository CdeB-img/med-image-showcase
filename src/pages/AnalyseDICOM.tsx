      ...
      <div className="min-h-screen flex flex-col bg-background">
        <main className="flex-1 py-20 px-4">
          <div className="max-w-5xl mx-auto space-y-20">
            ...
            <ExpertiseHero
              badge="Méthodologie des données"
              badgeIcon={Workflow}
              title="Analyse DICOM et structuration multicentrique"
              description="Audit technique, cohérence géométrique, contrôle des métadonnées critiques et structuration des jeux de données avant segmentation, IA et biomarqueurs."
              chips={["Conformité DICOM", "Traçabilité", "Multicentrique"]}
              actions={[
                { label: "Initier un audit DICOM", to: "/contact", variant: "primary", icon: ArrowRight },
                { label: "Voir bases multicentriques", to: "/bases-multicentriques", variant: "secondary", icon: Database },
              ]}
            />
