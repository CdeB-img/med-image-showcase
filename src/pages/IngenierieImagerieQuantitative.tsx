        ...
        <span className="text-sm text-muted-foreground">
          Métriques, exports (CSV/Excel/NIfTI/DICOM), overlays QC, logs, et synthèse par patient/temps.
                ...
                <div className="rounded-2xl border border-primary/20 bg-gradient-to-b from-card/80 to-primary/5 p-8 space-y-6 h-full shadow-sm">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Les contrôles qualité sont intégrés à chaque étape pour garantir un résultat stable,
                    interprétable et comparable entre patients et entre centres.
                  </p>
                  ...
                  <ul className="space-y-4 pt-2">
                    <li className="flex gap-4">
                      ...
                      <div>
                        <strong className="text-foreground block text-sm">Traçabilité et versioning</strong>
                        <span className="text-sm text-muted-foreground">
                          Version Git, paramètres figés et logs d’exécution conservés pour chaque run.
                        </span>
                      </div>
                    </li>
                    ...
                    <li className="flex gap-4">
                      <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                      <div>
                        <strong className="text-foreground block text-sm">Validation des mesures</strong>
                        <span className="text-sm text-muted-foreground">
                          Séparation stricte inférence/mesure, vérifications automatiques et seuils de cohérence.
                        </span>
                      </div>
                    </li>
                    ...
                    <li className="flex gap-4">
                      <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                      <div>
                        <strong className="text-foreground block text-sm">Robustesse opérationnelle</strong>
                        <span className="text-sm text-muted-foreground">
                          Détection des échecs, fallback contrôlé et reproductibilité conteneurisée multicentrique.
                        </span>
                      </div>
                    </li>
                  </ul>
