...
export const SEMANTIC_RECONSTRUCTION_PROMPT_VERSION = "SEM-001-RECONSTRUCTION-1.5" as const;
export const SEMANTIC_CRITIC_PROMPT_VERSION = "SEM-001-CRITIC-1.6" as const;
