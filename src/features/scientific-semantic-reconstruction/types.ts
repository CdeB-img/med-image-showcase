...
export const SEMANTIC_RECONSTRUCTION_PROMPT_VERSION = "SEM-001-RECONSTRUCTION-1.3" as const;
export const SEMANTIC_CRITIC_PROMPT_VERSION = "SEM-001-CRITIC-1.4" as const;
