...
describe("P-WEB-02 — preserved public boundaries after FUNCTIONAL-RESET-01", () => {
  ...
  it("keeps the demo noindex follow", () => expect(read("src/features/protocol-designer/functional-reset/ProtocolDesignerWorkspace.tsx")).toContain('<meta name="robots" content="noindex, follow" />'));
