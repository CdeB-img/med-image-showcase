...
export type ResearchProjectConstructionInput = {
  ...
  existingDecisionRecords: HumanDecisionEnvelope[];
...
export type StudyDesignCandidate = {
  designId: string;
  family: "CROSS_SECTIONAL_OBSERVATIONAL" | "PROSPECTIVE_LONGITUDINAL_COHORT" | "RETROSPECTIVE_LONGITUDINAL_COHORT" | "AMBISPECTIVE_LONGITUDINAL_COHORT" | "PROSPECTIVE_PROGNOSTIC_COHORT" | "METHODOLOGICAL_VALIDATION" | "COMPARATIVE_OBSERVATIONAL" | "INTERVENTIONAL_COMPARATIVE_STUDY" | "CASE_CONTROL";
  label: string;
...
export type ProjectDecisionRecord = HumanDecisionEnvelope;
...
export const researchProjectConstructionInputSchema = z.object({
  ...
  imagingDesignResult: z.unknown().nullable(), knownPopulationInformation: stringArray, knownTemporalInformation: stringArray, knownConstraints: stringArray, existingDecisions: stringArray, existingDecisionRecords: z.array(humanDecisionEnvelopeSchema), uncertainties: stringArray, contradictions: stringArray,
