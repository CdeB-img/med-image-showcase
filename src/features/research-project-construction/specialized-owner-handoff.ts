...
export const SPECIALIZED_OWNER_CAPABILITIES = Object.freeze([
  ...
  },
  {
    ...
    status: "AVAILABLE_WITH_LIMITATIONS",
    implementationVersion: "1.0.0",
    inputContract: "ObservabilityMeasurementRuntimeInput",
    outputContract: "ObservabilityMeasurementResult",
    pd003V2Compatibility: "NATIVE",
    readsProjectSnapshot: true,
    canProduceProjectContribution: true,
    canWriteProject: false,
    externalProvider: "NONE",
    limitations: [
      "ObservableProperty, MeasurementDefinition and BiomarkerRole outputs remain non-adopted OBS results.",
      "Only a separately selected Project-owned consequence may cross the existing Human Review boundary.",
      "Imaging realization and statistical planning remain explicit downstream handoffs.",
    ],
  },
  {
  ...
  },
  {
    ...
    status: "AVAILABLE_WITH_LIMITATIONS",
    implementationVersion: "1.0.0",
    inputContract: "CanonicalStudyDataRuntimeInput",
    outputContract: "CanonicalStudyDataResult",
    pd003V2Compatibility: "NATIVE",
    readsProjectSnapshot: true,
    canProduceProjectContribution: false,
    canWriteProject: false,
    externalProvider: "NONE",
    limitations: [
      "IMPLEMENTED_AND_PRODUCT_WIRED: QRY may dispatch a canonical representation need to CDM and Standard projects its read-only result.",
      "Research Project remains owner of DataNeed, CanonicalVariable and ExpectedVariableOccasion scientific meaning.",
      "Expected occasions never fabricate VariableOccurrences; realized examples are accepted only as explicit synthetic test fixtures.",
    ],
  },
  {
    ...
    status: "AVAILABLE_WITH_LIMITATIONS",
    implementationVersion: "1.0.0",
    inputContract: "DataManagementReasoningRuntimeInput",
    outputContract: "DataManagementReasoningResult",
    pd003V2Compatibility: "NATIVE",
    readsProjectSnapshot: true,
    canProduceProjectContribution: false,
    canWriteProject: false,
    externalProvider: "NONE",
    limitations: [
      "IMPLEMENTED_AND_PRODUCT_WIRED: QRY may dispatch operational data-management reasoning from an exact retained CDM result.",
      "Contracts model collection, quality, correction and lifecycle distinctions without executing real ingestion, storage, EDC or release operations.",
      "Scientific meaning and statistical strategy remain owned upstream or downstream.",
    ],
  },
  {
