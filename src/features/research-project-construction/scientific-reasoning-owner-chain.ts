...
export type ScientificReasoningOwnerObservation = {
  ...
  invocationId: string;
  handoffId: string;
  owner: "SCIENTIFIC_THINKING" | "STUDY_DESIGN" | "OBSERVABILITY_MEASUREMENT" | "IMAGING" | "BIOSTATISTICS" | "STUDY_DATA_CDM" | "DATA_MANAGEMENT";
  capabilityId: "SCIENTIFIC_THINKING_PROPOSAL" | "STUDY_DESIGN_COHERENCE" | "OBSERVABILITY_QUALIFICATION" | "IMAGING_STUDY_DESIGN" | "BIOSTATISTICS_PLANNING" | "STUDY_DATA_PLANNING" | "DATA_MANAGEMENT_PLANNING";
