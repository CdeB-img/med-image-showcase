...
export const analyzeGaps = (
  ...
  if (["NO_PROVIDER", "NO_MATCH", "PARTIAL"].includes(coverageStatus)) push("EXTERNAL_RESEARCH_REQUIRED", "FUTURE_EXTERNAL_RESEARCH", "La connaissance interne est insuffisante pour fermer cette question. Une recherche scientifique externe séparée serait nécessaire ; elle n’a pas été réalisée.", conceptIds, "Autoriser ultérieurement un workflow de recherche externe gouverné, hors ENG-002.");
