...
const rules: ConceptRule[] = [
  ...
  { conceptId: "biomarker:cmro2", preferredLabel: "CMRO₂", objectType: "BIOMARKER", patterns: [/\bcmro2\b/, /\bcmro₂\b/, /m[eé]tabolisme c[eé]r[eé]bral de l[' ]oxyg[eè]ne/, /consommation (?:c[eé]r[eé]brale )?d[' ]oxyg[eè]ne/], providerConcepts: { "rb-005": ["CMRO₂"] } },
  { conceptId: "biomarker:cerebral-perfusion", preferredLabel: "perfusion cérébrale", objectType: "PHYSIOLOGICAL_CONSTRUCT", patterns: [/perfusion c[eé]r[eé]br/, /d[eé]bit c[eé]r[eé]br/, /\bcbf\b/, /\bcbv\b/, /\btmax\b/], providerConcepts: { "p5-multidomain": ["cbf", "cbv", "tmax"], "rb-005": ["perfusion cérébrale"] } },
