...
export const stableValidationStringify = (value: unknown) => JSON.stringify(canonicalize(value));

export const validationDigest = (value: unknown) => {
  const input = stableValidationStringify(value);
